...
import { createLedgerConnector } from './ledger-connector'

// Ledger logo as inline SVG (identical to the one used by RainbowKit's ledgerWallet)
const LEDGER_ICON =
...
export function ledgerHardwareWallet(): Wallet {
  ...
  return {
    ...
    // Show as "not installed" in Firefox where WebHID is unavailable
    installed: isWebHIDSupported,
    downloadUrls: {
      chrome: 'https://www.google.com/chrome/',
      edge: 'https://www.microsoft.com/edge',
      desktop: 'https://www.google.com/chrome/',
    },
    createConnector: (walletDetails: WalletDetailsParams) => createLedgerConnector(walletDetails),
  }
}
